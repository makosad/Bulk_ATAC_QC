...
# tool="/home/aalvarez/Bulk_ATAC_QCmetrics_tool" # Already defined in wrapper

blacklist=$tool"/data/ENCFF000KJP.bed"
chromSizes=$tool"/data/hg19.chromSizes"
promoters=$tool"/data/promoterhg19_2kb.bed" # adapted, 2KB long
chrBed=$tool"/data/chromS.bed"
black_M=$tool"/data/M_size.bed"
allRLsNFR=$tool"/data/allRLs_Novaseq_Processed_NFR_peaks.narrowPeak"
...
do
	...
	/home/dmakosa/working_data_01/apps/miniconda3/envs/deeptoolsenv/bin/macs2 callpeak --nomodel --extsize 150 --shift -75 -t $fBam -f BAM -n ${subBam/.bam/_NFR} --keep-dup all --gsize hs	
	...
	cut -f1-3 ${subBam/.bam/_NFR_peaks.narrowPeak} | /home/dmakosa/working_data_01/apps/miniconda3/envs/deeptoolsenv/bin/intersectBed -u -wa -a - -b $promoters | samtools view -L - -c -b $fBam > ${subBam/.bam/_ReadsInNFRpeaks_overProm}
	...
	then 
		...
		cut -f1-3 ${subBam/.bam/_NFR_peaks.narrowPeak} ${subBam/.bam/_Tn5Insert_peaks.narrowPeak} | sort -k1,1 -k2,2n  | /home/dmakosa/working_data_01/apps/miniconda3/envs/deeptoolsenv/bin/mergeBed -i - | grep -v chrM | /home/dmakosa/working_data_01/apps/miniconda3/envs/deeptoolsenv/bin/bedtools subtract -a $chrBed -b - | samtools view -L - -c -b $fBam > ${subBam/.bam/_ReadsInBackground}
	else
		echo -e "\tData is PE ---> BAMPE option" 
		echo -e "\t13. MACS2:::params for PE fragments TLEN"
		/home/dmakosa/working_data_01/apps/miniconda3/envs/deeptoolsenv/bin/macs2 callpeak -t $fBam -f BAMPE -n ${subBam/.bam/_BAMPE} --keep-dup all --gsize hs	
		...
		cut -f1-3 ${subBam/.bam/_BAMPE_peaks.narrowPeak} | /home/dmakosa/working_data_01/apps/miniconda3/envs/deeptoolsenv/bin/intersectBed -u -wa -a - -b $promoters | samtools view -L - -c -b $fBam > ${subBam/.bam/_ReadsInBAMPEfrag_overProm}	
		...
		cut -f1-3 ${subBam/.bam/_NFR_peaks.narrowPeak} ${subBam/.bam/_BAMPE_peaks.narrowPeak} | sort -k1,1 -k2,2n  | /home/dmakosa/working_data_01/apps/miniconda3/envs/deeptoolsenv/bin/mergeBed -i - | grep -v chrM | /home/dmakosa/working_data_01/apps/miniconda3/envs/deeptoolsenv/bin/bedtools subtract -a $chrBed -b - | samtools view -L - -c -b $fBam > ${subBam/.bam/_ReadsInBackground}
	fi
