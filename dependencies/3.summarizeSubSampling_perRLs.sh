...
do
	...
	siete=$(cut -f1-3 $dirI/*_$p*NFR_peaks.narrowPeak | /home/dmakosa/working_data_01/apps/miniconda3/envs/deeptoolsenv/bin/intersectBed -u -wa -a - -b /scratchfs/oclement/Bulk_ATAC_QCmetrics_tool/data/promoterhg19_2kb.bed | wc -l)	
	...
	dieciseis=$(cut -f1-3 $dirI/*_$p*BAMPE_peaks.narrowPeak | /home/dmakosa/working_data_01/apps/miniconda3/envs/deeptoolsenv/bin/intersectBed -u -wa -a - -b /scratchfs/oclement/Bulk_ATAC_QCmetrics_tool/data/promoterhg19_2kb.bed | wc -l)	
	#OUTFILEperRL
